/**
  ...
  $Revision: 42930 58ce4deff217a770a7573d81640b246f22ee0ec7 $
  $Date: 2020-09-15 15:05:44 $

  FORKID {1FDF0D08-45B6-4EAD-A71D-7BA04089886D}
*/

description = "IPD DATRON M8";
vendor = "DATRON";
...
properties = {
  ...
  language: "en", // specifies the language "en" or "de"
...
propertyDefinitions = {
  ...
  minimumSpindleRPM: {title:"Minimum spindle RPM", description:"Specifies the lowest available rpm for the spindle.", type:"integer", range:[0, 999999999]}
};
...
function onSection() {
  ...
  */
  ...
  if (insertToolCall ||
    ...
    if (spindleSpeed < properties.minimumSpindleRPM) {
